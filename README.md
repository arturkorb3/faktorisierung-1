...
File: `paper_A_joux_buchmann_barrier.md`
...
File: `paper_B_regulator_compression_barrier.md`
...
File: `paper_C_CRT_walls_HPMI.md`

### Consolidated Reference Document

Internal reference document unifying all three research strands under a common CRT-wall thesis. The three standalone papers above are extracted from and consistent with this document.

File: `consolidated_paper.md`
...
These notes are published by Artur Korb as the human orchestrator and curator of the project.
